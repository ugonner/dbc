                                  ...
                                  try {
                                    await new Promise((resolve) => {
                                      const data: IChatMessage = {
                                        ...
                                        sender: userRef.current || {userName: "Anonymous", userId: "anonymous"},
                                        receiver: chat?.users.find((usr) => usr.userId !== userRef.current?.userId) || DBCChatUser as IChatUser
                                      };
                                      socketRef?.current?.emit(TalkableChatEvents.CHAT_MESSAGE, data, resolve);
                                    });
                                    setMessage("");
